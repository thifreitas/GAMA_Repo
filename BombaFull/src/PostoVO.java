...
/**
 *
 * @author Jefferson dos Santos de Carvalho (28254444)
 * @author2 Gabriel Pereira Felix (28253246)
 */
public class PostoVO {
    ...
    public float[] tanques = new float[4]; //0 = Etanol | 1 = Gasolina Comum | 2 = Gasolina Aditivada | 3 = Diesel
    public int[] servicos = new int[5]; //0 = Ducha | 1 = Óleo | 2 = Balanceamento | 3 = Café | 4 = Total
    public float[] litrosVendidos = new float[5]; //0 = Etanol | 1 = Gasolina Comum | 2 = Gasolina Aditivada | 3 = Diesel | 4 = Total
    public float[] litrosComprados = new float[5]; //0 = Etanol | 1 = Gasolina Comum | 2 = Gasolina Aditivada | 3 = Diesel | 4 = Total
    ...
    public String relatorioLucros() {
        ...
        tmpRelatorioLucros += "Lucro líquido = R$ " + rs.format((this.lucroCombustiveis - this.despesaCombustiveis)) + "\n";
        tmpRelatorioLucros += "-------------------------\n";
