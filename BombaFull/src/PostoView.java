...
public class PostoView {
    ...
    public PostoView() {
        PostoVO objVO = new PostoVO(); //Instancia uma objeto da classe PostoVO

        JOptionPane.showMessageDialog(null, "Bem vindo ao Posto 3CIC !!!", "Bem vindo", JOptionPane.INFORMATION_MESSAGE);
        ...
        do {
            opcao = Integer.parseInt(JOptionPane.showInputDialog(null, menu1, "Posto 3CIC", JOptionPane.INFORMATION_MESSAGE));
